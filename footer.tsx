    ...
    <footer className="bg-gradient-to-b from-primary/5 to-primary/10 border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2 text-muted-foreground hover:text-primary transition-colors">
                ...
                <span>Nehru Nagar Crossing, Bargadh Chauraha, Raebareli</span>
              </div>
              ...
              <div className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                ...
                <span>info@themaxhospital.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-muted-foreground">
          <p>&copy; {currentYear} The Max Hospital. All rights reserved.</p>
